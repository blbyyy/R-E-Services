    ...
    <div id="addCitationForm" class="col-md-12" style="display: none;">
        <div class="card">
            <div class="card-body">
                ...
                <form class="row g-3" method="POST" action="{{ route('staffAddCitation') }}">
                    @csrf
    ...
    <div class="card">
        <div class="card-body">
          ...
          <table class="table table-hover">
            ...
            <tbody>
                @foreach ($staffCitation as $staffCitations)
                    <tr>
                        <td>
                            <button data-id="{{$staffCitations->id}}" type="button" class="btn btn-info staffCitationShowBtn" data-bs-toggle="modal" data-bs-target="#staffShowCitaionInfo"><i class="bi bi-eye"></i></button>
                            <button data-id="{{$staffCitations->id}}" type="button" class="btn btn-primary staffcitationEditBtn" data-bs-toggle="modal" data-bs-target="#staffEditCitationInfo"><i class="bi bi-pencil-square"></i></button>
                            <button data-id="{{$staffCitations->id}}" type="button" class="btn btn-danger staffCitationDeleteBtn"><i class="bi bi-trash"></i></button>
                        </td>
                        <td>{{$staffCitations->researchTitle}}</td>
                        <td>{{$staffCitations->date}}</td>
                        <td>{{$staffCitations->conferenceForum}}</td>
                        <td>{{$staffCitations->venue}}</td>
                        <td>{{$staffCitations->country}}</td>
                    </tr>
                @endforeach
            </tbody>
          </table>

          <div class="modal fade" id="staffShowCitaionInfo" tabindex="-1">
          ...
          <div class="modal fade" id="staffEditCitationInfo" tabindex="-1">
            <div class="modal-dialog modal-lg">
              <div class="modal-content">
                <div class="modal-header" >
                  ...
                  <div class="card">
                    <div class="card-body">
                      ...
                      <form id="citationInfoForm" class="row g-3" enctype="multipart/form-data">
                        ...
                        <div >
                          <button  type="submit" class="btn btn-primary staffCitationUpdateBtn">Save Changes</button>
