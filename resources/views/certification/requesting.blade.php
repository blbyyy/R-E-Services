    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form id="certificationform" class="row g-3" enctype="multipart/form-data">
            @csrf
          ...
          <label>Is there an initial run of a similarity test (turnitin) by your research adviser?</label>
            ...
            <div class="col-12" style="padding-top: 20px">
              ...
              <button type="submit" class="btn btn-outline-dark applycertification">Apply Certification</button>
              </div>
            </div>
